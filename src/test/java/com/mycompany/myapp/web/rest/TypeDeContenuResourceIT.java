...
import com.mycompany.myapp.Test00123App;
 ...
 */
@SpringBootTest(classes = { Test00123App.class, TestSecurityConfiguration.class })
...
public class TypeDeContenuResourceIT {
    ...
    public void createTypeDeContenu() throws Exception {
        ...
        restTypeDeContenuMockMvc.perform(post("/api/type-de-contenus").with(csrf())
    ...
    public void updateTypeDeContenu() throws Exception {
        ...
        restTypeDeContenuMockMvc.perform(put("/api/type-de-contenus").with(csrf())
            .contentType(MediaType.APPLICATION_JSON)
            .content(TestUtil.convertObjectToJsonBytes(typeDeContenuDTO)))
            .andExpect(status().isOk());
    ...
    public void deleteTypeDeContenu() throws Exception {
        ...
        restTypeDeContenuMockMvc.perform(delete("/api/type-de-contenus/{id}", typeDeContenu.getId()).with(csrf())
